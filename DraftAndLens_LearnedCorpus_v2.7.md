...
## Version 2.7 — Generalised principles with worked illustrations
...
This distinction is load-bearing for the product. If the voices are sanded down toward tradition-neutral correctness, the 27-voice system collapses into 27 identical editors and the feature is destroyed. The voices are sold *as* subjective — surfaced to the writer as "a reading, not a ruling," explicitly partial, valuable precisely because they disagree with each other and with the editor.
...
The same applies to the voices, with one difference: a voice gives its example **in its own register**. Bukowski's example will be plainer; Nabokov's more precise and ornate; Carver's more compressed. The example is explicitly that voice's hand — "here's how *I'd* put it" — never a neutral or authoritative version. Five voices may offer five different examples for the same line, and that is correct: it shows the writer the range of sensibilities, not a single right answer.
