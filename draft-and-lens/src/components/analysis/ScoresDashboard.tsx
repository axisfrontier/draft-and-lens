...
function scoreLabel(s: number): string {
  ...
  return 'Not yet serving the work';
}
    ...
    <section style={{ marginTop: '0' }}>
      ...
      >
        ...
        <div>
          ...
          <div style={{ ...captionStyle, marginBottom: '1rem', color: 'var(--ink-faint)', fontStyle: 'normal' as const }}>
            Each dimension scored 1–10 by the model against your identified tradition. Higher = stronger alignment. Scores are generated by the same analysis pass that produces the written reading.
          </div>
          <div
            style={{
              display: 'grid',
