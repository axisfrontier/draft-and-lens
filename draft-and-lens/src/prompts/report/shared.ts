 ...
 * writer.
 */
export const WHERE_TO_GROW_NEXT = `ONE forward direction for the WRITER — not for this draft. Everything above says what this piece needs; this says what the writer could build next, on their own terms.
